...
//static u32     update_time = TEMPERATURE_QUERY_SLOW_SECONDS;
...
void menuConfirmLoad(void)
{
  ...
  popupDrawPage(DIALOG_TYPE_QUESTION, bottomDoubleBtn, textSelect(LABEL_WARNING), textSelect(LABEL_CONFIRM_LOAD), textSelect(LABEL_CONFIRM), textSelect(LABEL_CANCEL));
...
{
  u16 key_num = IDLE_TOUCH;
  popupDrawPage(DIALOG_TYPE_QUESTION, bottomDoubleBtn, textSelect(LABEL_WARNING), textSelect(LABEL_CONFIRM_UNLOAD), textSelect(LABEL_CONFIRM), textSelect(LABEL_CANCEL));
